...
class AuctionServiceTest {
    ...
    void createListingDeductsDeposit() {
        ...
        service.createListing(seller, "Seller", "minecraft:diamond", "Diamond", null,
                1, ListingType.BUYOUT, new BigDecimal("100.00"), 24, "gold", ItemCategory.MISC);
    ...
    void createListingPersistsToStorage() {
        ...
        AuctionListing listing = service.createListing(
                ...
                1, ListingType.BUYOUT, new BigDecimal("50.00"), 12, "gold", ItemCategory.MISC);
    ...
    void createListingFailsWithZeroPrice() {
        ...
        assertThrows(AuctionService.AuctionException.class, () ->
                service.createListing(seller, "Seller", "minecraft:diamond", "Diamond", null,
                        1, ListingType.BUYOUT, BigDecimal.ZERO, 24, "gold", ItemCategory.MISC));
    }
    ...
    void createListingFailsWithUnknownCurrency() {
        ...
        assertThrows(AuctionService.AuctionException.class, () ->
                service.createListing(seller, "Seller", "minecraft:diamond", "Diamond", null,
                        1, ListingType.BUYOUT, new BigDecimal("10.00"), 24, "unknown_coin", ItemCategory.MISC));
    }
    ...
    void buyListingTransfersFundsAndCreatesParcels() {
        ...
        service.buyListing(buyer, "Buyer", listing.id());
    ...
    void buyListingFailsWhenBuyerIsAlsoSeller() {
        ...
        assertThrows(AuctionService.AuctionException.class, () ->
                service.buyListing(seller, "Seller", listing.id()));
    }
    ...
    void buyListingFailsForAlreadySoldListing() {
        ...
        AuctionListing listing = createSword(seller);
        service.buyListing(buyer1, "Buyer1", listing.id());

        assertThrows(AuctionService.AuctionException.class, () ->
                service.buyListing(buyer2, "Buyer2", listing.id()));
    }
    ...
    void expireListingsReturnsBuyoutItemToSeller() throws Exception {
        ...
        AuctionListing listing = new AuctionListing(
                ...
                ItemCategory.MISC, past, ListingStatus.ACTIVE, 20L, past - 86_400_000L);
    ...
    void expireListingsCompletesAuctionWithBids() {
        ...
        AuctionListing listing = new AuctionListing(
                ...
                ItemCategory.WEAPONS, past, ListingStatus.ACTIVE, 400L, past - 86_400_000L);
        storage.createListing(listing);
    ...
    void searchListingsReturnsGroupedResults() {
        ...
        service.createListing(seller, "Seller", "minecraft:diamond", "Diamond", null,
                1, ListingType.BUYOUT, new BigDecimal("50.00"), 24, "gold", ItemCategory.MISC);
        service.createListing(seller, "Seller", "minecraft:diamond", "Diamond", null,
                5, ListingType.BUYOUT, new BigDecimal("45.00"), 24, "gold", ItemCategory.MISC);
        service.createListing(seller, "Seller", "minecraft:emerald", "Emerald", null,
                1, ListingType.BUYOUT, new BigDecimal("80.00"), 24, "gold", ItemCategory.MISC);
    ...
    void getListingDetailReturnsAllListingsForItem() {
        ...
        service.createListing(seller, "Seller", "minecraft:iron_ingot", "Iron Ingot", null,
                1, ListingType.BUYOUT, new BigDecimal("5.00"), 24, "gold", ItemCategory.MISC);
        service.createListing(seller, "Seller", "minecraft:iron_ingot", "Iron Ingot", null,
                10, ListingType.BUYOUT, new BigDecimal("4.50"), 24, "gold", ItemCategory.MISC);
